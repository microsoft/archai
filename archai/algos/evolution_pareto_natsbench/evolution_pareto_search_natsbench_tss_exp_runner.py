...
from archai.nas.model_desc_builder import ModelDescBuilder
from archai.algos.evolution_pareto_natsbench.evolution_pareto_search_natsbench_tss import EvolutionParetoSearchNatsbenchTSS



class EvolutionParetoSearchNatsbenchTSSExpRunner(ExperimentRunner):
    ...
    def searcher(self)->Searcher:
        return EvolutionParetoSearchNatsbenchTSS()
