...
class AircraftBingProvider(DatasetProvider):
    ...
    def get_datasets(self, load_train:bool, load_test:bool,
        ...
        if load_train:
            trainpath = os.path.join(self._dataroot, 'aircraft', 'train_bing')            
...
register_dataset_provider('aircraft_bing', AircraftBingProvider)