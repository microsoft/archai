...
if __name__ == '__main__':
  train = ImageNet16('C:\\Users\\dedey\\dataroot\\imagenet16', True , None) 
  valid = ImageNet16('C:\\Users\\dedey\\dataroot\\imagenet16', False, None) 

  print ( len(train) )
  print ( len(valid) )
  image, label = train[111]
  trainX = ImageNet16('C:\\Users\\dedey\\dataroot\\imagenet16', True , None, 120)
  validX = ImageNet16('C:\\Users\\dedey\\dataroot\\imagenet16', False , None, 120)
  print ( len(trainX) )
  print ( len(validX) )
'''
