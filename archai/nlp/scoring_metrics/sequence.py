...
class TextPredictionPosition:
    ...
    @classmethod
    def from_smart_compose_ljson(cls: TextPredictionPosition, line: Any) -> TextPredictionPosition:
    ...
    def unique_id(self) -> str:
        """Returns the unique identifier of the corresponding position.
    ...
    def to_smart_compose_ljson(self) -> str:
        """Converts class to SmartCompose ljson format.
