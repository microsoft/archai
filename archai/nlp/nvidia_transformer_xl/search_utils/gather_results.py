...
from archai.nlp.nvidia_transformer_xl.search_utils.utils import process_parameters, config2key, get_yaml_values
from archai.nlp.nvidia_transformer_xl.search_utils.profiler import get_model_profile
...
def main(args):
  if args.analyze:    # provides 2 plots: 1) common ratio versus topk and 2) spearman corr versus topk
    ...
    # plt.xlim((-1, 101))
    # plt.ylim((-1, 101))
    plt.savefig('params_corr.png', bbox_inches="tight")
