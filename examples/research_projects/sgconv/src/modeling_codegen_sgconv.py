...
class CodeGenSGConv(nn.Module):
    def __init__(self, config):
        ...
        # NOTE: d_state is 64 as a placeholder
        # bidirectional must be false in autoregressive
...
class CodeGenBlock(nn.Module):
    ...
    def forward(
        ...
        conv_output = self.sgconv(hidden_states, attention_mask, layer_past, head_mask, use_cache)
