...
# 2020.12.01-NAS, Microsoft Research
# Modified from https://github.com/huawei-noah/Efficient-AI-Backbones/blob/master/ghostnetv2_pytorch/model/ghostnetv2_torch.py
...
class GhostNetV2(nn.Module):
    def __init__(self, cfgs, num_classes=1000, width=1.0, dropout=0.2,block=GhostBottleneckV2,args=None):
        ...
        for cfg in self.cfgs:
            layers = []
            for k, exp_ratio, c, se_ratio, s in cfg:
                exp_size = _make_divisible (input_channel * exp_ratio, 16)
