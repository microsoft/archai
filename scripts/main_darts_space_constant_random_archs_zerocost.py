...
def main():
    parser = argparse.ArgumentParser(description='Darts Space Constant Random Zero Cost Wrapper Main')
    parser.add_argument('--algos', type=str, default='zerocost_darts_space_constant_random',
    ...
    for arch_id in archs_to_proc:
        ...
        command_list = ['python', 'scripts/main.py', '--full', '--algos', f'{args.algos}',\
                        ...
                        '--exp-prefix', f'zerocost_darts_space_constant_random_{arch_id}', '--datasets', f'{args.datasets}']
