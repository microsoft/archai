...
def main():
    ...
    # loop over the different random seed jobs
    for key in logs.keys():
        # get total duration of the run 
        # which is the sum of all regular trainings for 
        # each architecture

        duration = 0.0

        # a particular random seed job
        ...
        # find the test error of the best model at search
        # time after fully training it
        best_test = logs[key]['best_model_full_training']['arch_train']['best_test']['top1'] * 100.0
